...
csv_titles = [
    f'H:/stOOrz-Mathematical-Modelling-Group/IMMC_2022_International/Programming/simulation_of_plane_boarding/ours/different occasions/discompliance_output_csv_random/log{i}.csv'
